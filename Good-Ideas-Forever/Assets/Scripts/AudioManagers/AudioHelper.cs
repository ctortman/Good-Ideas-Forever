...
public class AudioHelper : MonoBehaviour 
{
	...
	// fade our AudioSource object based on speed 
	// (> 0 fades volume up, < 0 fades volume out, == 0 assumes the sound is playing and just destroys it)
	public static IEnumerator FadeAudioObject(GameObject aObject, float fadeSpeed)
	{
		...
		{ 
			if  (null != apAnim[apAnim.clip.name])
